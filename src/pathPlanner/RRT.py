...
def RRT(img, img2, start, end, stepSize):
    ...
    while pathFound==False:
        ...
        if directCon and nodeCon:
            ...
            cv2.circle(img2, (int(tx),int(ty)), 2,(0,0,255),thickness=1, lineType=8)
            ...
            cv2.imwrite("SMART_step15(media).jpg",img2)
            break
...
if __name__ == '__main__':
    ...
    img2 = cv2.imread(IMAGE_NAME) # load colored maze image
